...
<header class="reg-header ">
    <div class=" container ">
        <div class="row p-4 ">
            <p id="heading" class="col-md-8 mt-5 fw-bold">Registration For Vaccine</p>
...
<main class="container mt-5">
    <div class="row">
        ...
        <section class="second-part col-md-8">
            ...
            @include('website.pages.registration.NID_registration')
            {{-- Registraion Form For NID End --}}


            {{-- Registraion Form For Birth Certificate Start --}}
            @include('website.pages.registration.birth_certificate_registration')
            {{-- Registraion Form For Birth Certificate End --}}


            {{-- Registraion Form For Passport Start --}}
            @include('website.pages.registration.passport_registration')
            {{-- Registraion Form For Passport End --}}


            {{-- How to Registraion (info) Start --}}
            @include('website.pages.registration.registration_info')
            {{-- How to Registraion (info) Start --}}
        </section>
    </div>
</main>
...
<script>
    ...
    document.getElementById('handlNIDBtn').addEventListener('click',function() {
        ...
        document.getElementById('heading').innerText = 'Registration with NID';
        ...
        // other button
        document.getElementById('handleBirthBtn').style.backgroundColor = '#E7EDF5';
        document.getElementById('handleBirthBtn').style.color = '#000000';
        document.getElementById('handlePassportBtn').style.backgroundColor = '#E7EDF5';
    ...
    document.getElementById('handleBirthBtn').addEventListener('click',function() {
        ...
        document.getElementById('heading').innerText = 'Registration with Birth Certificate';
        ...
        // other button
        document.getElementById('handlNIDBtn').style.backgroundColor = '#E7EDF5';
    ...
    document.getElementById('handlePassportBtn').addEventListener('click',function() {
        ...
        document.getElementById('heading').innerText = 'Registration with Passport';
